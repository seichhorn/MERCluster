...
def fullClusteringSubset():
	...
	ex1.cluster(resolution=args.resolution, clusterMin=args.clusterMin, trackIterations=args.trackIterations, fileNameIteration = args.fileNameIteration, cellTypeName = args.cellTypeName)

if __name__ == '__main__':
	fullClusteringSubset()
